...
public class VentanaPrincipal extends JFrame implements ActionListener{
	...
	public VentanaPrincipal() {
		...
		textoIntroduccion = "Aplicacion basica de ejemplo del uso "
				+ "de diseño utilizando MVC.\n\n"
				+ "La aplicacion permite registrar, actualizar, buscar y eliminar registros de una tabla de Clientes.";
